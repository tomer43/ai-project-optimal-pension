class Fund:
    def __init__(self, fund_details):
        ...
        self.rating = fund_details[5]
        self.return_rating = fund_details[6]
        self.risk_rating = fund_details[7]
        self.fund_net_annual_expense_ratio = fund_details[8]
        self.category_net_annual_expense_ratio = fund_details[9]
        self.asset_cash = fund_details[10]
        self.asset_stocks = fund_details[11]
        self.asset_bonds = fund_details[12]
        self.asset_others = fund_details[13]
        self.asset_preferred = fund_details[14]
        self.asset_convertable = fund_details[15]
        self.price_earnings_ratio = fund_details[16]
        self.price_book_ratio = fund_details[17]
        self.price_sales_ratio = fund_details[18]
        self.price_cashflow_ratio = fund_details[19]
        self.median_market_cap = fund_details[20]
        self.sector_basic_materials = fund_details[21]
        self.sector_consumer_cyclical = fund_details[22]
        self.sector_financial_services = fund_details[23]
        self.sector_real_estate = fund_details[24]
        self.sector_consumer_defensive = fund_details[25]
        self.sector_healthcare = fund_details[26]
        self.sector_utilities = fund_details[27]
        self.sector_communication_services = fund_details[28]
        self.sector_energy = fund_details[29]
        self.sector_industrials = fund_details[30]
        self.sector_technology = fund_details[31]
        self.net_asset_value = fund_details[32]
        self.fund_returns = fund_details[33]
        self.category_return = fund_details[34]
        self.sector_others = fund_details[35]
        self.last_quarter_returns = fund_details[36]
        self.last_year_returns = fund_details[37]
        self.last_3_years_returns = fund_details[38]
        self.last_5_years_returns = fund_details[39]
        self.category_last_quarter_returns = fund_details[40]
        self.category_last_year_returns = fund_details[41]
        self.category_last_3_years_returns = fund_details[42]
        self.category_last_5_years_returns = fund_details[43]
    ...
    def __str__(self):
        ...
        fund_str += '\t' + 'rating:\t' + str(self.rating) + '\n'
        fund_str += '\t' + 'return_rating:\t' + str(self.return_rating) + '\n'
        fund_str += '\t' + 'risk_rating:\t' + str(self.risk_rating) + '\n'
        fund_str += '\t' + 'fund_net_annual_expense_ratio:\t' + str(self.fund_net_annual_expense_ratio) + '\n'
        fund_str += '\t' + 'category_net_annual_expense_ratio:\t' + str(self.category_net_annual_expense_ratio) + '\n'
        ...
        fund_str += '\t' + 'category_return:\t' + str(self.category_return) + '\n'
        fund_str += '\t' + 'sector_others:\t' + str(self.sector_others) + '\n'
        fund_str += '\t' + 'last_quarter_returns:\t' + str(self.last_quarter_returns) + '\n'
        fund_str += '\t' + 'last_year_returns:\t' + str(self.last_year_returns) + '\n'
        fund_str += '\t' + 'last_3_years_returns:\t' + str(self.last_3_years_returns) + '\n'
        fund_str += '\t' + 'last_5_years_returns:\t' + str(self.last_5_years_returns) + '\n'
        fund_str += '\t' + 'category_last_quarter_returns:\t' + str(self.category_last_quarter_returns) + '\n'
        fund_str += '\t' + 'category_last_year_returns:\t' + str(self.category_last_year_returns) + '\n'
        fund_str += '\t' + 'category_last_3_years_returns:\t' + str(self.category_last_3_years_returns) + '\n'
        fund_str += '\t' + 'category_last_5_years_returns:\t' + str(self.category_last_5_years_returns) + '\n'
