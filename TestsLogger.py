...
def run_tests(n, investor_type, debug_mode=False, investor_kwargs=None):
    ...
    for _ in tqdm(range(n), desc="\tProgress"):
        sim = Simulator(df, INITIAL_MONEY, investor_type, debug_mode, funds_names, investor_kwargs)
